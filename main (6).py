...
students1 = [Student("Aliya", "A001", 9.5), Student("Bob", "B002", 8.7), Student("Charu", "C003", 9.2)]
students2 = [Student("David", "D004", 7.8), Student("Enow", "E005", 8.9), Student("Frank", "F006", 8.3)]
